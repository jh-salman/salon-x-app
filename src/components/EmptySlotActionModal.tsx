...
const ClipboardIcon = () => (
  <View style={styles.iconContainer}>
    ...
    <View style={styles.iconSvgWrapper}>
      <Svg width={16} height={16} viewBox="0 0 12 14.6667" style={styles.iconSvg}>
        <Path
...
const CalendarIcon = () => (
  <View style={styles.iconContainer}>
    ...
    <View style={styles.iconSvgWrapper}>
      <Svg width={16} height={16} viewBox="0 0 12 13.3333" style={styles.iconSvg}>
        <Path
...
const EditIcon = () => (
  <View style={styles.iconContainer}>
    ...
    <View style={styles.iconSvgWrapper}>
      <Svg width={16} height={16} viewBox="0 0 12.0017 12.0017" style={styles.iconSvg}>
        <Path

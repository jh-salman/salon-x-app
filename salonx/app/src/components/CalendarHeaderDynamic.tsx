  ...
  return (
    <View style={{ width: ms(14.6), height: vs(9.5) }}>
      <Svg width="15.6059" height="10.1073" viewBox="0 0 15.6059 10.1073" fill="none">
        <G>
          <Path d={svgPaths.p104c6e00} stroke={primaryColor} strokeWidth="0.6" fill="none" />
          <Path d={svgPaths.p339b00} stroke={primaryColor} strokeWidth="0.6" fill="none" />
        </G>
      </Svg>
    </View>
  );
  ...
  return (
    <View style={styles.tabSelectorContainer}>
      ...
      <Pressable onPress={() => handleTabPress('day')} style={[styles.tabLabel, { left: ms(-5), width: ms(77.22) }]}>
        <Text style={[styles.tabText, viewMode === 'day' && [styles.activeTabText, { color: primaryColor }]]}>Day</Text>
      </Pressable>

      <Pressable onPress={() => handleTabPress('week')} style={[styles.tabLabel, { left: ms(67), width: ms(55) }]}>
        <Text style={[styles.tabText, viewMode === 'week' && [styles.activeTabText, { color: primaryColor }]]}>5 Day</Text>
      </Pressable>

      <Pressable onPress={() => handleTabPress('month')} style={[styles.tabLabel, { left: ms(130), width: ms(55) }]}>
        <Text style={[styles.tabText, viewMode === 'month' && [styles.activeTabText, { color: primaryColor }]]}>Month</Text>
      </Pressable>
    </View>
  );
};
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.dateNavigation}>
        <TabSelector viewMode={viewMode} onViewModeChange={handleViewModeChange} primaryColor={primaryColor} />
      </View>

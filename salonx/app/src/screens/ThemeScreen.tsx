...
const OPTIONS: { value: PrimaryTheme; label: string; color: string }[] = [
  { value: 'purple', label: 'Rich purple', color: highlightColors.richPurple },
  { value: 'bloodRed', label: 'Blood red', color: highlightColors.bloodRed },
  { value: 'charcoal', label: 'Charcoal', color: highlightColors.charcoalAccent },
  { value: 'black', label: 'Black', color: highlightColors.matteBlack },
  { value: 'lime', label: 'Lime', color: highlightColors.limeNeon },
